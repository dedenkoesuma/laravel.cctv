...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-1">Update Ruijie network product information</p>
        </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="specifications" name="specifications" rows="6"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Format: Key: Value (Satu per baris)">{{ old('specifications', is_array($product->specifications) ? implode("\n", $product->specifications) : $product->specifications) }}</textarea>
                ...
                <div>
                    <label for="image" class="block text-sm font-semibold text-gray-700 mb-2">
                        Product Image {{ $product->image ? '(Upload new to replace)' : '' }}
                    </label>
