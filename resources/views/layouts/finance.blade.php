...
<head>
    ...
    <style>
        ...
        .navbar-link svg { width: 18px; height: 18px; transition: transform 0.3s ease; }
        .navbar-link:hover svg { transform: scale(1.1); }
        ...
        .navbar-item.show .dropdown-arrow { transform: rotate(180deg); }
        ...
        @media (min-width: 993px) {
            ...
            .navbar-item:hover .dropdown-arrow { transform: rotate(180deg); }
        }
        ...
        .dropdown-item.active { background: rgba(59, 130, 246, 0.2); color: white; }
        ...
        .mobile-menu-toggle:hover { background: rgba(59, 130, 246, 0.2); transform: scale(1.05); }
        ...
        @media (max-width: 992px) {
            ...
            .navbar-menu.show { display: flex; animation: slideDown 0.3s ease; }
            ...
            .navbar-link { width: 100%; padding: 14px 16px; border-radius: 10px; }
            ...
            .navbar-item.show .dropdown-menu-custom { max-height: 500px; padding: 8px; }
            ...
            if (window.innerWidth > 992) {
                document.querySelectorAll('.dropdown-parent').forEach(function(parent) {
                    ...
                    parent.addEventListener('mouseleave', function() {
                        const cur = this;
                        closeTimeout = setTimeout(function() { cur.classList.remove('show'); }, DROPDOWN_CLOSE_DELAY);
                    });
                });
            }
