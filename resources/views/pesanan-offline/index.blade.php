...
<div class="flex min-h-screen">
    ...
    <div class="flex-1 p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-xl font-medium text-gray-800">Pesanan Offline</h1>
                <p class="text-sm text-gray-500">Kelola pesanan dari pelanggan yang datang langsung</p>
            </div>
        ...
        <form method="GET" action="{{ route('pesanan-offline.index') }}"
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex gap-2">
                                    ...
                                    <form method="POST" action="{{ route('pesanan-offline.status', $p->id) }}">
                                        @csrf @method('PATCH')
                                        <button type="submit"
