...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 min-w-0 p-6 lg:p-8 bg-[#0B0F19] overflow-y-auto">
        ...
        <div class="mb-6 pb-6 border-b border-white/10">
            ...
            <h1 class="text-2xl font-bold font-display text-white tracking-tight">Detail Pesanan Offline</h1>
            <p class="text-sm text-slate-400 mt-1">Rincian spesifikasi cetak langsung pelanggan walk-in</p>
        </div>
        ...
        <div class="max-w-2xl glass-card rounded-2xl p-6 lg:p-8">
            <div class="flex items-center justify-between pb-6 mb-6 border-b border-white/10">
                <div>
                    ...
                    <h2 class="text-xl font-bold font-mono text-blue-400 mt-0.5">{{ $pesanan->no_order }}</h2>
                </div>
                @php
                    $statusStyle = [
            ...
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm mb-6">
                ...
                <div>
                    ...
                    <dd class="text-slate-100 font-medium">{{ $pesanan->tipe_kertas }}</dd>
                </div>
                <div>
                ...
                <div>
                    <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400 mb-1">Tanggal Transaksi</dt>
                    <dd class="text-slate-100 font-mono">{{ $pesanan->tanggal }}</dd>
                </div>
                <div class="sm:col-span-2">
                    <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400 mb-1">Total Biaya</dt>
            ...
            <div class="flex items-center justify-between pt-6 border-t border-white/10">
                ...
                <div class="flex items-center gap-2">
                    <form method="POST" action="{{ route('pesanan-offline.status', $pesanan->id) }}">
                        ...
                        @method('PATCH')
                        <button type="submit"
                                class="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-medium bg-blue-500/15 hover:bg-blue-500/25 text-blue-300 border border-blue-500/30 transition">
