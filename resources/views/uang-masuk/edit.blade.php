    ...
    <div class="flex-1 p-6">
        <div class="mb-6">
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-1">
                ...
                <span>/</span>
                <span class="text-gray-800">Edit transaksi</span>
            </div>
            <h1 class="text-xl font-medium text-gray-800">Edit Uang Masuk</h1>
        </div>
        ...
        <div class="max-w-xl bg-white rounded-xl border p-6">
            ...
            <form method="POST" action="{{ route('uang-masuk.update', $transaksi->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <select name="kategori"
                            class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-300">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="catatan" rows="3"
                              class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-300">{{ old('catatan', $transaksi->catatan) }}</textarea>
                </div>
